...
def train(sd_file: str, cpc: bool, seed: int, split_seed: int, noise: bool,
          num_words: int, backend: str, batch_size: int, iterations: int,
          max_epochs: int, lr: float, weight_decay: float):
    pl.seed_everything(seed)
    dm = VerifierDataModule(cpc, num_words, batch_size, iterations,
...
def test(all_subsets: bool, sd_file: str, cpc: bool, seed: int,
         split_seed: int, noise: bool, num_words: int, backend: str,
         batch_size: int, test_games: int):
    pl.seed_everything(seed)
    dm = VerifierDataModule(cpc, num_words, batch_size,
...
class VerifierDataModule(pl.LightningDataModule):
    def __init__(self, cpc: bool, num_words: int, batch_size: int,
        ...
        if not cpc:
            ...
            self.dset = timit.TimitCPC(data_dir, val_size, seed)
